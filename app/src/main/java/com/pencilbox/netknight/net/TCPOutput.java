...
public class TCPOutput extends Thread {
    ...
    //从队列中读到的队列数据
    private BlockingQueue<Packet> mOutputQueue;
    ...
    public TCPOutput(BlockingQueue<ByteBuffer> inputQueue, BlockingQueue<Packet> outputQueue, VpnService vpnService, Selector selector, BlockingQueue<App> appCacheQueue) {
